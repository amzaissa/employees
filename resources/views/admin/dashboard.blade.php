                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent"
                        ...
                        <ul class="nav nav-pills mr-auto justify-content-end">
                            <li class="nav-item active">
                                <a class="nav-link text-light" href="{{route('dashboard.create')}}">Add Employee <span
                                            ...
                                            <li class="notification-box">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 col-sm-8 col-8">
                                                        ...
                                                        <div>
                                                          <a href="{{route('not',$notification->data['user_id'])}}">Admin {{$notification->data['status']}} {{$notification->data['name']}}</a>  
                                                        </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$user->address}}</td>
                    <td>
                        <a href="{{ route('dashboard.edit', $user->id) }}" class="btn btn-primary btn-sm">Edit</a>
